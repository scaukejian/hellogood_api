...
//		 */
//		String toDelChatgroupid = "263238032839147956";
...
//		dataObjectNode.put("owner", "10002045");
...
//        * -H 'Authorization: Bearer {token}'
//		 */
//		String addToChatgroupid = "263238032839147956";
//		String toAddUsername = "90001538";
...
//         * -H "Authorization: Bearer {token}"
//		 */
//		String[] chatgroupIDs = {"9766195757058","1488711279534"};
...
//         * -H 'Authorization: Bearer {token}'
//		 */
//		String chatgroupid = "264631220753662388";
...
//		 */
		String toAddBacthChatgroupid = "1479267220393";
		ArrayNode usernames = JsonNodeFactory.instance.arrayNode();
		usernames.add("10002045");
